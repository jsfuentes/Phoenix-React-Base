defmodule ReactPhoenixWeb.Strategy.Google do
  @moduledoc """
  ...
  def handle_request!(conn) do
    ...
    redirect!(conn, ReactPhoenixWeb.Strategy.Google.OAuth.authorize_url!(params, opts))
  end
  ...
  def handle_callback!(%Plug.Conn{params: %{"code" => code}} = conn) do
    ...
    case ReactPhoenixWeb.Strategy.Google.OAuth.get_access_token(params, opts) do
      {:ok, token} ->
  ...
  defp fetch_user(conn, token) do
    ...
    resp = ReactPhoenixWeb.Strategy.Google.OAuth.get(token, get_userinfo_endpoint(conn))
